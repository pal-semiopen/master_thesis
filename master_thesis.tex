...
\begin{proof}
    ...
    まず、次の図式は可換である。
    % https://q.uiver.app/#q=
    \[\begin{tikzcd}
        ...
        \arrow["{\mu_{A,Y}\tensor F(Y)}"', from=1-5, to=1-3]
...
\begin{theorem}[{$\Lambda[\R]\simeq \C$}]
    ...
    包含函手$i:\R\to\C$から、$\Lambda$の普遍性により函手$\bar{i}:\Lambda[\R]\to\C$はisoである。    
\end{theorem}
